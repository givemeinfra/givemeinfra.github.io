...
import treeview.views.frmGetMessages;
import treeview.views.frmSendMessage;
...
public class FocusControl extends ControlAdapter {
    ...
    public void itemClicked(VisualItem item, MouseEvent e) {    	
        ...
        if ( UILib.isButtonPressed(e, button2) && e.getClickCount() == ccount ) // Right Click
        {        	
    		...
    		{   
	        	try
	    		{
		        	...
		        	frmSendMessage frmSend = new frmSendMessage(clickedEntity, activities);
        ...
        if ( UILib.isButtonPressed(e, button) && e.getClickCount() == ccount ) // Left Click
        {
    		...
    		{   
	        	try
	    		{
		        	frmGetMessages frmGet = new frmGetMessages(clickedEntity);
		        	frmGet.setLocationRelativeTo(null);
		        	frmGet.setVisible(true);
	    		}
	    		catch(Exception a)
	    		{
	    			a.printStackTrace();
