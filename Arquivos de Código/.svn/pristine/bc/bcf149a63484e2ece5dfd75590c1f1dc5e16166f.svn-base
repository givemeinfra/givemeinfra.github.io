...
import prefuse.demosRadial.TreeView;
...
import radialview.prefuse.controls.WheelZoomControl;
...
public class TreeView extends Display {
    ...
    public static final String TREE_CHI = "C:/Analisador/TreeViewRastreabilidadeComponente.xml";
    ...
    public static void main(String argv[]) {
        ...
        JFrame frame = new JFrame("Visualizador: representação gráfica da relação entre componentes");
