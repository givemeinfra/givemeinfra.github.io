...
public class OrdenaPorcentagem implements Comparable<OrdenaPorcentagem> {
	    ...
	    public OrdenaPorcentagem()
	    {
	    	
	    }
        
	    public OrdenaPorcentagem(int pid, int prandomID, String pnome, int pocorrencia, String pcomponenteAssociado, float pporcentagemAssociada) 
	    {
	        super();
	        this.setId(pid);
	    ...
	    public int compareTo(OrdenaPorcentagem modulo) {
