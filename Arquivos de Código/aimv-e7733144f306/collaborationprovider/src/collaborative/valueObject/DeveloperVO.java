...
public class DeveloperVO  implements java.io.Serializable {
    ...
    private collaborative.valueObject.ProjectVO projectVO;
    ...
    public DeveloperVO(
           ...
           collaborative.valueObject.ProjectVO projectVO,
     ...
     * @return projectVO
     */
    public collaborative.valueObject.ProjectVO getProjectVO() {
        return projectVO;
    }
     ...
     * @param projectVO
     */
    public void setProjectVO(collaborative.valueObject.ProjectVO projectVO) {
        this.projectVO = projectVO;
    }
